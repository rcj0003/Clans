...
public class ItemBuilder {
	...
	public ItemBuilder(ItemStack stack) {
		this(stack.getType(), stack.getAmount(), stack.getDurability(), stack.getEnchantments(),
				stack.getItemMeta().getDisplayName(), stack.getItemMeta().getLore(),
				new ArrayList<ItemFlag>(stack.getItemMeta().getItemFlags()));
		this.stack = stack;
	}

	public ItemBuilder(Material type) {
		this(type, 1, (short) 0, new HashMap<Enchantment, Integer>(), null, new ArrayList<String>(),
	...
	public ItemBuilder addLore(Collection<String> content) {
